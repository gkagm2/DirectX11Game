...
void CScriptMgr::GetScriptInfo(vector<wstring>& _vec)
{
	...
	_vec.push_back(L"CFlameParticle_bu");
...
CScript * CScriptMgr::GetScript(const wstring& _strScriptName)
{
	...
	if (L"CChainsaw_bu" == _strScriptName)
		return new CChainsaw_bu;
	...
	if (L"CExitDoorEndCol_bu" == _strScriptName)
	...
	if (L"CFlameParticle_bu" == _strScriptName)
		return new CFlameParticle_bu;
...
CScript * CScriptMgr::GetScript(UINT _iScriptType)
{
	...
	case (UINT)SCRIPT_TYPE::CAMERAFOLLOWERSCRIPT:
		return new CCameraFollowerScript;
		break;
	case (UINT)SCRIPT_TYPE::CHAINSAW_BU:
		return new CChainsaw_bu;
		break;
	...
	case (UINT)SCRIPT_TYPE::EVENTFUNCTEST:
		return new CEventFuncTest;
		break;
	case (UINT)SCRIPT_TYPE::EXITDOORENDCOL_BU:
		return new CExitDoorEndCol_bu;
		break;
	...
	case (UINT)SCRIPT_TYPE::EXPLOSION_BU:
		return new CExplosion_bu;
		break;
	case (UINT)SCRIPT_TYPE::FLAMEPARTICLE_BU:
		return new CFlameParticle_bu;
		break;
...
const wchar_t * CScriptMgr::GetScriptName(CScript * _pScript)
{
	...
	case SCRIPT_TYPE::CHAINSAW_BU:
		return L"CChainsaw_bu";
		break;
	...
	case SCRIPT_TYPE::EXITDOORENDCOL_BU:
		return L"CExitDoorEndCol_bu";
		break;
	...
	case SCRIPT_TYPE::FLAMEPARTICLE_BU:
		return L"CFlameParticle_bu";
		break;
